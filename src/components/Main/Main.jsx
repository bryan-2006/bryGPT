  ...
  return (
    <div className='main'>
        ...
        <div className="main-container">
            ...
            <div className="cards">
                <div className="card">
                    <p>Suggest beautiful places to see in an upcoming roadtrip</p>
            ...
            <div className="main-bottom">
                ...
                <p className="bottom-info">
                    bryGPT, powered by Gemini, may display innacurate info, including about
                    people, so double-check responses with a higher authority. 
                </p>
            </div>
        </div>
    </div>
